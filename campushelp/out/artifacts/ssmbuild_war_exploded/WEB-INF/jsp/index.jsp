...
<div class="top-wrap white">
    <div class="top-inner clear">
        <div class="top-logo-wrap clear">
            <h1 class="top-logo none"><a href="index.html" class="nav-brand">后台管理</a></h1>
        ...
        <div class="result-wrap">
            ...
            <div class="result-content">
                <div class="short-wrap">
                    <a href="/book/insert"><i class="icon-font">&#xe001;</i>新增作品</a>
